...
function Init() {
    ...
    ptr thread3Handle = GC_CreateThread(Thread3);
    kernel32.SetThreadPriority(thread3Handle, g.kernel32_THREAD_PRIORITY_TIME_CRITICAL);  // Realtime priority gives us the best chance for 60hz screenrefresh.
}
