...
ptr window = sdl3.SDL_CreateWindow("Snake", SCREEN_WIDTH, SCREEN_HEIGHT, 0);
...
WavPlayer wavPowerup;
wavPowerup.Load("sound/sfxr/powerup.wav", &wavPlayerSpec);
function playSound() { wavPowerup.Play(); }
...
SoundtrackerInit("sound/mod/pyramide.mod");
