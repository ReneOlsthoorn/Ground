...
dll chipmunk function cpBodyNewKinematic();				// result: cpBody*
...
dll chipmunk function cpBodySetAngularVelocity(ptr cpBody, float angularVelocity);
...
dll chipmunk function cpShapeFilterNew(int grp, int cat1, int cat2);
dll chipmunk function cpShapeSetFilter(ptr shape, ptr filter);
...
dll chipmunk function cpBodySetAngle(ptr cpBody, float angle);
dll chipmunk function cpSpaceStep(ptr space, float dt);
dll chipmunk function cpBodyApplyImpulseAtWorldPoint(ptr cpBody, ptr cpVectImpulse, ptr cpVectPoint);
dll chipmunk function cpBodyApplyImpulseAtLocalPoint(ptr cpBody, ptr cpVectImpulse, ptr cpVectPoint);

dll chipmunk function cpSpaceAddShape(ptr space, ptr shape);
dll chipmunk function cpSpaceRemoveShape(ptr space, ptr shape);
...
dll chipmunk function cpShapeGetSpace(ptr shape) : ptr;
