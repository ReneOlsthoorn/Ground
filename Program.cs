...
namespace GroundCompiler
{
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (args.Length == 0)
            {
                fileName = "sudoku.g";  //unittests  sudoku  smoothscroller  smoothscroller_optimized  jump  racer  mode7  mode7_optimized  chipmunk_tennis  plasma_non_colorcycling  fire  win32-screengrab  bertus  snake  game-of-life  tetrus
