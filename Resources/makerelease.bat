...
call :compileExample gpu_circles
call :compileExample gpu_fireworks
call :compileExample gpu_spiral
call :compileExample gpu_tempotypen
...
call :compileExample raylib_cosmic
call :compileExample raylib_cube
call :compileExample raylib_fireball
call :compileExample raylib_intercircles
call :compileExample raylib_intro
call :compileExample raylib_loga
call :compileExample raylib_plasma
call :compileExample raylib_quantum
