...
WavPlayer wavExplosion;
wavExplosion.Load("sound/sfxr/explosion4.wav", &wavPlayerSpec);
WavPlayer wavDrop;
wavDrop.Load("sound/sfxr/hit3.wav", &wavPlayerSpec);
WavPlayer wavTurn;
wavTurn.Load("sound/sfxr/select.wav", &wavPlayerSpec);
function playSound() { wavExplosion.Play(); }
function playDrop() { wavDrop.Play(); }
function playTurn() { wavTurn.Play(); }
...
SoundtrackerInit("sound/mod/tip - princess of dawn.mod");
