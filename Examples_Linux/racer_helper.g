...
if (pl1Surface == null) { sdl3.SDL_ShowSimpleMessageBox(g.SDL_MESSAGEBOX_INFORMATION, "Message", "The file cannot be found!", null); return; }
ptr pl1Texture = sdl3.SDL_CreateTextureFromSurface(renderer, pl1Surface);
if (pl1Texture == null) { sdl3.SDL_ShowSimpleMessageBox(g.SDL_MESSAGEBOX_INFORMATION, "Message", "Texture not available!", null); return; }
sdl3.SDL_DestroySurface(pl1Surface);

ptr pl2Surface = sdl3_image.IMG_Load("image/racer_p2_37x76.png");
ptr pl2Texture = sdl3.SDL_CreateTextureFromSurface(renderer, pl2Surface);
sdl3.SDL_DestroySurface(pl2Surface);

ptr pl3Surface = sdl3_image.IMG_Load("image/racer_p3_54x75.png");
ptr pl3Texture = sdl3.SDL_CreateTextureFromSurface(renderer, pl3Surface);
sdl3.SDL_DestroySurface(pl3Surface);

ptr pl7Surface = sdl3_image.IMG_Load("image/racer_p7_37x76.png");
ptr pl7Texture = sdl3.SDL_CreateTextureFromSurface(renderer, pl7Surface);
sdl3.SDL_DestroySurface(pl7Surface);

ptr pl8Surface = sdl3_image.IMG_Load("image/racer_p8_54x75.png");
ptr pl8Texture = sdl3.SDL_CreateTextureFromSurface(renderer, pl8Surface);
sdl3.SDL_DestroySurface(pl8Surface);

ptr backgroundSurface = sdl3_image.IMG_Load("image/racer_background.png");
