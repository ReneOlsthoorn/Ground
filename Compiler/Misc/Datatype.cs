...
namespace GroundCompiler
{
    public class Datatype
    {
        ...
        public static Dictionary<string, Datatype> Cached = new() {
            ...
            { "integer",    Datatype.FromData("integer",    [ TypeEnum.Number, TypeEnum.Integer, TypeEnum.Signed ], isValueType:true, nrBytes:8) },
            ...
            { "boolean",    Datatype.FromData("boolean",    [ TypeEnum.Boolean ], isValueType:true, nrBytes:8) },
