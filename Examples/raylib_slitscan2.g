...
void main()
{
    ...
    finalColor = texture(texture0, pt) * rInv / 2.0;

    //finalColor = mix(texture(texture0, pt * 0.5) * rInv * 0.8, vec4(1.0, 1.0, 1.0, 1.0), smoothstep(4.5, 6.0, rInv));
    //finalColor = vec4(1.0, 0.5, 0.5, 0.5);
}`;
